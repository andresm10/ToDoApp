           ...
           <?php echo csrf_field(); ?>
            <div class="jumbotron jumbotron-fluid">
                ...
                <div class="row form-group">
                  ...
                  <div class="col-8">
                    <input type="text" id="nit" name="nit" class="form-control" placeholder="Identificaci&oacute; de empresa" value="">
                  </div>
                </div>
                <div class="row form-group">
                  <div class="col-4 text-left">
                  ...
                  <div class="col-8">
                    <input type="text" id="username" name="username" class="form-control" placeholder="E-mail" required autofocus value="">
                  </div>
                </div>
                <div class="row  form-group">
                  <div class="col-4 text-left">
                ...
                <p class="mt-5 mb-3 text-muted">&copy; Logicalsoft SAS </p>
                </div>
            </div>
        </form>
    </body>
