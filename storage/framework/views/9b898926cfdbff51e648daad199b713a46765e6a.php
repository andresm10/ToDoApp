...
<body>
	<p>
	 ...
	 <p>
		...
		<ul>
			<li>
				<a href="<?php echo e($link); ?>" target="_blank">Generar nueva Contrase&ntilde;a</a>
			</li>
		</ul>
 	...
 	<p>
		...
		El cambio de contrase&ntilde;a fue pedido desde la IP: <?php echo e($ip); ?> si no eres t&uacute; y esta situaci&oacute;n se repite en mas de 3 ocasiones, puedes enviarnos los mensajes que recibas al correo <a href="mailto:andresmajin7@gmail.com">andresmajin7@gmail.com</a> para solicitar asistencia.<br />
