		...
		<?php echo e(Form::open(array('url' => '/editPermissionInfo', 'method'=>'post'))); ?>
	        ...
	        <div class="row">
          	...
          	<div class="row form-group">
	          	...
	          	<div class="col-6">
	          		<label for="modulos"><strong><?php echo e($permission->module->description); ?></strong></label>
	          	</div>
	        </div>
          	...
          	<div class="row form-group">
	          	...
	          	<div class="col-6">
	          		<input type="text" name="name" id="name" value="<?php echo e($permission->name_front); ?>" required class="form-control">
	          	</div>
          	</div>
